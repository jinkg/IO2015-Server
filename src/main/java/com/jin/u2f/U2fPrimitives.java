...
import com.jin.u2f.crypto.BouncyCastleCrypto;
import com.jin.u2f.crypto.ChallengeGenerator;
import com.jin.u2f.crypto.Crypto;
import com.jin.u2f.crypto.RandomChallengeGenerator;
import com.jin.u2f.data.DeviceRegistration;
import com.jin.u2f.data.messages.AuthenticateRequest;
import com.jin.u2f.data.messages.AuthenticateResponse;
import com.jin.u2f.data.messages.ClientData;
import com.jin.u2f.data.messages.RegisterRequest;
import com.jin.u2f.data.messages.RegisterResponse;
import com.jin.u2f.exceptions.DeviceCompromisedException;
import com.jin.u2f.exceptions.U2fBadInputException;
import com.jin.u2f.key.RawAuthenticateResponse;
import com.jin.u2f.key.RawRegisterResponse;
import com.jin.u2f.key.util.U2fB64Encoding;
...
public class U2fPrimitives {
     ...
     *
     * @see U2fPrimitives#startAuthentication(String, com.jin.u2f.data.messages.yubico.u2f.data.DeviceRegistration, byte[])
     */
    ...
    /**
     * @see U2fPrimitives#finishAuthentication(com.yubico.u2f.data.messages.AuthenticateRequest, com.yubico.u2f.data.messages.AuthenticateResponse, com.jin.u2f.data.messages.yubico.u2f.data.DeviceRegistration, java.util.Set)
     */
